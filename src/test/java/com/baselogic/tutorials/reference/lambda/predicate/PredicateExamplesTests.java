...
import com.baselogic.tutorials.reference.lambda.stream.LambdaStreamExamples;
...
public class PredicateExamplesTests {

    private static final Logger logger = LoggerFactory.getLogger(PredicateExamplesTests.class);
